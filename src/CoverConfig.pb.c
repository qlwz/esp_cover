...
const pb_field_t CoverConfigMessage_fields[13] = {
    ...
    PB_FIELD(  9, BOOL    , SINGULAR, STATIC  , OTHER, CoverConfigMessage, autoStroke, led, 0),
    PB_FIELD( 20, UINT32  , SINGULAR, STATIC  , OTHER, CoverConfigMessage, pin_rx, autoStroke, 0),
